...
*   **Removing voice feature issues:** As of now the voice command feature only works on chrome and not on browsers like brave cause of the use of `SpeechRecognition API`. I hope to resolve this issue by using `MediaRecorder API` instead.
