  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row antialiased font-sans selection:bg-emerald-500/30">
      ...
      <section className="w-full md:w-1/2 p-6 md:p-12 overflow-y-auto border-b md:border-b-0 md:border-r border-slate-800/60 custom-scrollbar md:h-screen flex flex-col justify-between">
       ...
       {/* Static Email Badge */}
       <div className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-800 rounded-lg text-white text-sm cursor-default">
           <MailIcon />
           <span>saxenayogesh459@gmail.com</span>
           </div>
           {/* Static Phone Badge */}
           <div className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-800 rounded-lg text-white text-sm cursor-default">
            <PhoneIcon />
            <span>+91 7017362735</span>
            </div>
            {/* GitHub Link */}
            <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-800 rounded-lg text-white text-sm hover:bg-slate-800 transition-colors"
            >
