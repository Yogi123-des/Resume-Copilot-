        ...
        <div>
          ...
          <div className="mb-10 animate-fade-in">
            ...
            <div className="flex flex-col gap-2 mt-6 max-w-md">
               ...
               <div className="flex items-center gap-2 px-4 py-2 bg-stone-900 border border-amber-800 rounded-lg text-orange-300 text-sm cursor-default">
                  <PhoneIcon size={16} className="text-orange-400" />
               ...
               <div className="flex gap-2 w-full">
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-stone-900 border border-amber-800 rounded-lg text-white text-sm hover:bg-stone-800 transition-colors"
                  >
